...
<footer className="sm:pt-20 p-4 sm:p-6   bg-black  " >
    <div className="">
    <div className="w-4/5 lg:flex justify-center md: ">
        <div className="mb-6 sm:mb-12  ml-10  ">
        <a href={"###"} className="flex justify-center items-center">
    <img src={Logo} className="h-6 mr-2 sm:h-16" alt="Homeage" />
    <span className="self-center text-xl font-semibold whitespace-nowrap "><span className='text-purple-700 '>OP</span><span className="text-gray-200">RUX</span></span>
</a>
<span className="flex justify-center text-white mt-2"><p className=" md:w-1/2 text-center  ">This the plateform where you can hire a professional for your desired work. So You can Buy S of any kind from our trusted plateform </p></span>
        </div>

        <div className=" ml-10 grid grid-cols-2 gap-8 sm:gap-8 sm:grid-cols-3">
            <div >
                <h2 className="mb-6 text-md font-semibold text-gray-200 uppercase ">Quick Links</h2>
            ...
            <div >
                <h2 className="mb-6 text-md font-semibold text-gray-200 uppercase ">Legal</h2>
                <ul className="text-gray-200 ">
                    <li className="mb-2">
            ...
            <div>
                <h2 className="mb-6 text-md font-semibold text-gray-200 uppercase ">Get In Touch</h2>
                <ul className="text-gray-200 ">
                    <li className="mb-2">
                        <a href={"https://github.com/themesberg/flowbite"} className="hover:underline ">+92 307 0001606</a>
                    </li>
                    <li>
                        <a href={"https://discord.gg/4eeurUVvTy"} className="hover:underline">opruxofficial@gmail.com</a>
                    </li>
                    <li className="mt-2">
                        <a href={"https://discord.gg/4eeurUVvTy"} className="hover:underline">12 street, 2nd tower Rehman Plaza</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-200 sm:text-center ">© 2022 <a href="https://flowbite.com/" className="hover:underline">SaaD™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href={"#"} className="text-gray-200 hover:text-green-600 ">
